...
def heikin_ashi(klines):
    ...
    result_cols = ['ha_open', 'ha_high', 'ha_low', 'ha_close', 'color', '10EMA', '20EMA', '25MA', 'downtrend', 'smooth']
...
def downtrend(HA):
    return HA['25MA'] > HA['10EMA'] and HA['20EMA'] > HA['10EMA']
...
def short_despair(pair):
    ...
    condition_1m = downwards_movement(minute_1m) and all(minute_1m["smooth"].iloc[-3:]) and minute_1m["downtrend"].iloc[-1]
